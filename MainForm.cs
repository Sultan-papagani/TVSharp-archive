  ...
  public class MainForm : Form
  {
    ...
    private void frequencyCorrectionTimer_Tick(object sender, EventArgs e)
    {
      ...
      if (this._autoFrequencyCorrection)
      {
        ...
        {
          this.frequencyCorrectionNumericUpDown.Value = Decimal.op_Increment(this.frequencyCorrectionNumericUpDown.Value) % 200M;
          this._counterAutoFreqCorrect = 0;
        }
        else if (this._frequencyCorrection > this._autoCorrectX)
        {
          this.frequencyCorrectionNumericUpDown.Value = Decimal.op_Decrement(this.frequencyCorrectionNumericUpDown.Value) % 200M;
          this._counterAutoFreqCorrect = 0;
        }
        else if (this._frequencyCorrection == this._autoCorrectX)
        {
    ...
    private void InitializeComponent()
    {
      ...
      this.samplerateComboBox.Items.AddRange(new object[9]
      {
        (object) "3.0 MSPS",
